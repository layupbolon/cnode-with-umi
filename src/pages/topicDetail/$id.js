...
class TopicDetail extends React.PureComponent {
  componentDidMount() {
    ...
    dispatch({type: 'topicDetail/getTopicDetailData', payload: {id: match.params.id}});
  }
            ...
            <div className={styles.topicTopInfoDetail}>
              ...
              <div className={styles.authorInfo}>
                <p className={styles.authorInfo_p} style={{paddingTop: '15px'}}>
                  <span style={{color: '#80BD01'}}>{dataSource.author.loginname}</span>&nbsp;&nbsp;
...
export default withRouter(connect(mapStateToProps)(TopicDetail));
